...
1. **Infinite Barcode Scans:** Scan any cosmetics, makeup, or skincare barcode at Sephora, Target, or online.
2. **Brutally Honest Chemical Analysis:** Identifies hidden toxins, endocrine disruptors, suspected carcinogens, and allergens based on raw INCI list verified facts.
3. **Pore-Clogging Comedogenic Alerts:** Warns users instantly with bold red warning cards if a formula contains acne-triggering ingredients.
4. **Custom Shade Matcher:** Uses advanced camera-surface colorimetry analysis to find perfect makeup shades for your undertone.
5. **No Ads & Complete Privacy:** Fully secured user privacy under native iOS Apple Keychain.
